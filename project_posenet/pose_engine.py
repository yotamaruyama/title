...
POSENET_SHARED_LIB = os.path.join(
    #'posenet_lib', os.uname().machine, 'posenet_decoder.so')  /home/io-circle/windowapps/title/project_posenet
    '/home/io-circle/windowapps/title/project_posenet/posenet_lib', os.uname().machine, 'posenet_decoder.so')
